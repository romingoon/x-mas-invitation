...
export const CHOIRS = [
  {
    ...
    details: `한기림찬양대는 새문안교회 5부 청년예배의 찬양을 담당하며 '하나님을 한소리로 기리는 무리'라는 뜻의 찬양대입니다. 만18~35세의 청년들로 구성된 청년찬양대로, 1972년 조직되어 50년이상의 역사를 가지며 현재까지 청년들이 자발적으로 모여 군부대·병원 선교 찬양, 광화문 음악회 등 세상의 현장 속에서 그리스도의 향기를 음악으로 전하는 사명을 계속해 나가고 있습니다. 바쁜 일상 속에서도 하나님을 향한 마음으로 예배와 찬양의 자리에 기쁨으로 참여하고 있습니다.(대장 박형중, 지휘 안정현, 오르간 장연진)`,
  ...
  },
  {
    ...
    details: `
은나노 찬양대는 동숭교회 4부 청년예배의 찬양을 담당하며 <은>혜를 <나>누며 <노>래하는 찬양대입니다. 대학로 젊음의 거리 속에서 청년다운 열정과 목소리를 모아 오직 하나님께 영광 올리며, 성도들과 세상에 위로와 기쁨을 전하길 소망합니다.
