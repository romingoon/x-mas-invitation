export const FESTIVAL_INFO = {
  ...
  date: "2025.12.20 (토)",
  time: "오후 3시",
  location: "새문안교회 4층 대예배실",
  address: "서울시 종로구 새문안로 79",
  host: "새문안교회",
  churches: "새문안교회 · 동숭교회 · 자양교회 · 정릉교회",
  conductors: "안정현 · 조은영 · 조성은 · 김세희",
  invitationMessage: "기쁨과 감동이 흐르는 성탄 찬양제에\n여러분을 기쁨으로 초대합니다.",
  introText: `어려운 시대 속에서도 희망의 빛을 노래하기 위해 새문안·동숭·자양·정릉교회 청년 찬양대가 한자리에 모입니다. 성탄이 전하는 기쁨과 평화를 음악으로 나누며, 지역사회에 따뜻한 위로를 전하고자 합니다.\n
이번 청년 연합찬양제는 각 공동체가 서로의 은혜를 나누고, 영성과 실력을 함께 성장시키는 귀한 교제의 자리입니다. 청년들의 순수한 마음과 울림 있는 하모니를 통해 하늘의 평안을 다시 바라보는 시간이 되기를 소망합니다.

기쁨과 감동이 흐르는 성탄 찬양제에 여러분을 기쁨으로 초대합니다.`,
};
...
export const CHOIRS = [
  {
    ...
    details: `한기림찬양대는 새문안교회 5부 청년예배의 찬양을 담당하며 '하나님을 한소리로 기리는 무리'라는 뜻의 찬양대입니다. 만18~35세의 청년들로 구성된 청년찬양대로, 1972년 조직되어 50년이상의 역사를 가지며 현재까지 청년들이 자발적으로 모여 군부대·병원 선교 찬양, 광화문 음악회 등 세상의 현장 속에서 그리스도의 향기를 음악으로 전하는 사명을 계속해 나가고 있습니다. 바쁜 일상 속에서도 하나님을 향한 마음으로 예배와 찬양의 자리에 기쁨으로 참여하고 있습니다.
(대장 박형중, 지휘 안정현, 오르간 장연진)`,
    image: "/assets/han.jpeg",
  },
  {
    id: 2,
    name: "동숭교회 은나노찬양대",
    description: "<은>혜를 <나>누며 <노>래하는 찬양대",
    details: `은나노 찬양대는 동숭교회 4부 청년예배의 찬양을 담당하며 <은>혜를 <나>누며 <노>래하는 찬양대입니다. 대학로 젊음의 거리 속에서 청년다운 열정과 목소리를 모아 오직 하나님께 영광 올리며, 성도들과 세상에 위로와 기쁨을 전하길 소망합니다.
(대장 안민영, 지휘 조은영, 반주 이태운)`,
  ...
  },
  {
    ...
    details: `뒤나미스 찬양대는 자양교회 4부 청년예배의 찬양을 담당하고 있습니다. 뒤나미스(Dynamis)란 '힘', '가능성' 그리고 '하나님의 권능'이라는 뜻의 헬라어로, 뒤나미스는 하나님의 권능을 크게 외치며 "모양넘어, 능력으로" 나아가는 공동체입니다.
우리는 하나님께서 찾으시는 예배자로 서기 위해 노력하며, 온전한 찬양을 위해 고민하며 훈련하고 있습니다. 또한 신앙적 성숙과 풍성한 교제를 위해 다양한 프로그램과 모임으로 함께 성장하기를 기도합니다.
(대장 오재욱, 지휘 조성은, 반주 문예원)`,
...
할렐루야 찬양대는 정릉교회 4부 청년 예배의 찬양을 담당하며, 그 이름에 맞게 찬양으로 하나님 한 분을 높이는 찬양대입니다. 주일 예배 찬양과 추수감사절/부활절/성탄절 등 절기예배의 찬양을 담당하고 있습니다.
비록 큰 규모의 찬양대는 아니지만, 작은 울림이라도 하나님께서 기뻐 받으시는 향기로운 찬양이 되기를 소망하며 매주 정성껏 예배와 찬양의 자리를 지키고 있습니다.
(대장 임용철, 지휘 김세희, 반주 이영은)`,
...
export const PROGRAM = [
  ...
  { id: 7, title: "I Sing because I'm Happy", composer: "Arr. Rollo Dilworth", performer: "새문안교회 한기림 찬양대", details: "(지휘 안정현, 피아노 장연진)" },
  { id: 8, title: "왕께 찬양합니다", composer: "Arr.Camp Kirkland", performer: "새문안교회 한기림 찬양대", details: "(지휘 안정현, 피아노 장연진)" },
