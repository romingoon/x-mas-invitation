...
export function BottomNav() {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-secondary/20 pb-safe shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
